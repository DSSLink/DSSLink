...
def main(datasets_dir, outputs_dir, dname, group, dtype, epochs):
    ...
    sys.argv.append(f'--exp_name=model_lab{dtype}_epochs{epochs}')
    ...
    train_lab_examples = load_examples(os.path.join(args.data_dir, f'train_lab{dtype}'), model)
